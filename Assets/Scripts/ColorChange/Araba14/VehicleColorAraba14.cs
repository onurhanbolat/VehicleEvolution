...
public class VehicleColorAraba14 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (!PlayerPrefs.HasKey("kontrolAraba14"))
        {
            baslangicbodyrengi = PlayerPrefs.GetString("SavedBodyAraba14Color") + "8A8A8A";
            baslangicrimrengi = PlayerPrefs.GetString("SavedRimAraba14Color") + "313131";
            PlayerPrefs.SetString("SavedBodyAraba14Color", baslangicbodyrengi);
            PlayerPrefs.SetString("SavedRimAraba14Color", baslangicrimrengi);
            PlayerPrefs.SetInt("kontrolAraba14", 1);
        }
        else
        {
            PlayerPrefs.GetString("SavedBodyAraba14Color");
            PlayerPrefs.GetString("SavedRimAraba14Color");
        }
        kalicibodydiger.color = HexToColor(PlayerPrefs.GetString("SavedBodyAraba14Color"));
        kalicirimdiger.color = HexToColor(PlayerPrefs.GetString("SavedRimAraba14Color"));
    ...
    public void BodyColorChance()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba14>().MateyelEsitlemeBody();
        kalicirimdiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba14>().gecicirim.color;
    }
    ...
    public void WheelColorChance()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba14>().MateyelEsitlemeRim();
        kalicibodydiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba14>().gecicibody.color;
    ...
    public void BackButton()
    {
        ...
        chechFonkBody = false;
        checkFonk2 = true;
        kalicibodydiger.color = ColorPaletteControllerAraba14.Current.gecicibody.color;
        kalicirimdiger.color = ColorPaletteControllerAraba14.Current.gecicirim.color;
    }
    ...
    public void BodySellUpdateCoin()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba14>().UpdateColor();
