...
public class VehicleColorAraba19 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (!PlayerPrefs.HasKey("kontrolAraba19"))
        {
            baslangicbodyrengi = PlayerPrefs.GetString("SavedBodyAraba19Color") + "8A8A8A";
            baslangicrimrengi = PlayerPrefs.GetString("SavedRimAraba19Color") + "313131";
            PlayerPrefs.SetString("SavedBodyAraba19Color", baslangicbodyrengi);
            PlayerPrefs.SetString("SavedRimAraba19Color", baslangicrimrengi);
            PlayerPrefs.SetInt("kontrolAraba19", 1);
        }
        else
        {
            PlayerPrefs.GetString("SavedBodyAraba19Color");
            PlayerPrefs.GetString("SavedRimAraba19Color");
        }
        kalicibodydiger.color = HexToColor(PlayerPrefs.GetString("SavedBodyAraba19Color"));
        kalicirimdiger.color = HexToColor(PlayerPrefs.GetString("SavedRimAraba19Color"));
    ...
    public void BodyColorChance()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba19>().MateyelEsitlemeBody();
        kalicirimdiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba19>().gecicirim.color;
    }
    ...
    public void WheelColorChance()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba19>().MateyelEsitlemeRim();
        kalicibodydiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba19>().gecicibody.color;
    ...
    public void BackButton()
    {
        ...
        chechFonkBody = false;
        checkFonk2 = true;
        kalicibodydiger.color = ColorPaletteControllerAraba19.Current.gecicibody.color;
        kalicirimdiger.color = ColorPaletteControllerAraba19.Current.gecicirim.color;
    }
    ...
    public void BodySellUpdateCoin()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba19>().UpdateColor();
