...
public class ColorPaletteControllerAraba19 : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IInitializePotentialDragHandler
{
    public static ColorPaletteControllerAraba19 Current;
    ...
    {
        PlayerPrefs.SetString("SavedBodyAraba19Color", ColorToHexBody(color));
    }

    void SaveColorRim(Color color)
    {
        PlayerPrefs.SetString("SavedRimAraba19Color", ColorToHexRim(color));
    }
    ...
    public void UpdateColor()
    {
        ...
        if (pickedColorImage)
        {
            pickedColorImage.color = color;
            SelectedColor = color;
            if (VehicleColorAraba19.Current.chechFonkBody == true)
            {
                MateyelGuncellemeBody();
                SaveColorBody(kalicibody.color);
                VehicleColorAraba19.Current.chechFonkBody = false;
            }
            else if (VehicleColorAraba19.Current.checkFonkRim == true)
            {
                MateyelGuncellemeRim();
                SaveColorRim(kalicirim.color);
                VehicleColorAraba19.Current.checkFonkRim = false;
            }
            else if (VehicleColorAraba19.Current.chechFonkBody == false && VehicleColorAraba19.Current.checkFonk2 == true || VehicleColorAraba19.Current.checkFonkRim == false && VehicleColorAraba19.Current.checkFonk2 == true)
            {
                MateyelEsitlemeBody();
                MateyelEsitlemeRim();
            }
