...
public class ColorPaletteControllerAraba9 : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IInitializePotentialDragHandler
{
    public static ColorPaletteControllerAraba9 Current;
    ...
    {
        PlayerPrefs.SetString("SavedBodyAraba9Color", ColorToHexBody(color));
    }

    void SaveColorRim(Color color)
    {
        PlayerPrefs.SetString("SavedRimAraba9Color", ColorToHexRim(color));
    }
    ...
    public void UpdateColor()
    {
        ...
        if (pickedColorImage)
        {
            pickedColorImage.color = color;
            SelectedColor = color;
            if (VehicleColorAraba9.Current.chechFonkBody == true)
            {
                MateyelGuncellemeBody();
                SaveColorBody(kalicibody.color);
                VehicleColorAraba9.Current.chechFonkBody = false;
            }
            else if (VehicleColorAraba9.Current.checkFonkRim == true)
            {
                MateyelGuncellemeRim();
                SaveColorRim(kalicirim.color);
                VehicleColorAraba9.Current.checkFonkRim = false;
            }
            else if (VehicleColorAraba9.Current.chechFonkBody == false && VehicleColorAraba9.Current.checkFonk2 == true || VehicleColorAraba9.Current.checkFonkRim == false && VehicleColorAraba9.Current.checkFonk2 == true)
            {
                MateyelEsitlemeBody();
                MateyelEsitlemeRim();
            }
