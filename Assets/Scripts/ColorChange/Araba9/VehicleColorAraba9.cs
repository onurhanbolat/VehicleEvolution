...
public class VehicleColorAraba9 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (!PlayerPrefs.HasKey("kontrolAraba9"))
        {
            baslangicbodyrengi = PlayerPrefs.GetString("SavedBodyAraba9Color") + "8A8A8A";
            baslangicrimrengi = PlayerPrefs.GetString("SavedRimAraba9Color") + "313131";
            PlayerPrefs.SetString("SavedBodyAraba9Color", baslangicbodyrengi);
            PlayerPrefs.SetString("SavedRimAraba9Color", baslangicrimrengi);
            PlayerPrefs.SetInt("kontrolAraba9", 1);
        }
        else
        {
            PlayerPrefs.GetString("SavedBodyAraba9Color");
            PlayerPrefs.GetString("SavedRimAraba9Color");
        }
        kalicibodydiger.color = HexToColor(PlayerPrefs.GetString("SavedBodyAraba9Color"));
        kalicirimdiger.color = HexToColor(PlayerPrefs.GetString("SavedRimAraba9Color"));
    ...
    public void BodyColorChance()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba9>().MateyelEsitlemeBody();
        kalicirimdiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba9>().gecicirim.color;
    }
    ...
    public void WheelColorChance()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba9>().MateyelEsitlemeRim();
        kalicibodydiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba9>().gecicibody.color;
    ...
    public void BackButton()
    {
        ...
        chechFonkBody = false;
        checkFonk2 = true;
        kalicibodydiger.color = ColorPaletteControllerAraba9.Current.gecicibody.color;
        kalicirimdiger.color = ColorPaletteControllerAraba9.Current.gecicirim.color;
    }
    ...
    public void BodySellUpdateCoin()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba9>().UpdateColor();
