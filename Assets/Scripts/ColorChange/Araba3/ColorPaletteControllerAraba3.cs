...
public class ColorPaletteControllerAraba3 : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IInitializePotentialDragHandler
{
    public static ColorPaletteControllerAraba3 Current;
    ...
    {
        PlayerPrefs.SetString("SavedBodyAraba3Color", ColorToHexBody(color));
    }

    void SaveColorRim(Color color)
    {
        PlayerPrefs.SetString("SavedRimAraba3Color", ColorToHexRim(color));
    }
    ...
    public void UpdateColor()
    {
        ...
        if (pickedColorImage)
        {
            pickedColorImage.color = color;
            SelectedColor = color;
            if (VehicleColorAraba3.Current.chechFonkBody == true)
            {
                MateyelGuncellemeBody();
                SaveColorBody(kalicibody.color);
                VehicleColorAraba3.Current.chechFonkBody = false;
            }
            else if (VehicleColorAraba3.Current.checkFonkRim == true)
            {
                MateyelGuncellemeRim();
                SaveColorRim(kalicirim.color);
                VehicleColorAraba3.Current.checkFonkRim = false;
            }
            else if (VehicleColorAraba3.Current.chechFonkBody == false && VehicleColorAraba3.Current.checkFonk2 == true || VehicleColorAraba3.Current.checkFonkRim == false && VehicleColorAraba3.Current.checkFonk2 == true)
            {
                MateyelEsitlemeBody();
                MateyelEsitlemeRim();
            }
