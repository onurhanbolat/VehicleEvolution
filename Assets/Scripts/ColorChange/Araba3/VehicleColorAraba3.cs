...
public class VehicleColorAraba3 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (!PlayerPrefs.HasKey("kontrolAraba3"))
        {
            baslangicbodyrengi = PlayerPrefs.GetString("SavedBodyAraba3Color") + "8A8A8A";
            baslangicrimrengi = PlayerPrefs.GetString("SavedRimAraba3Color") + "313131";
            PlayerPrefs.SetString("SavedBodyAraba3Color", baslangicbodyrengi);
            PlayerPrefs.SetString("SavedRimAraba3Color", baslangicrimrengi);
            PlayerPrefs.SetInt("kontrolAraba3", 1);
        }
        else
        {
            PlayerPrefs.GetString("SavedBodyAraba3Color");
            PlayerPrefs.GetString("SavedRimAraba3Color");
        }
        kalicibodydiger.color = HexToColor(PlayerPrefs.GetString("SavedBodyAraba3Color"));
        kalicirimdiger.color = HexToColor(PlayerPrefs.GetString("SavedRimAraba3Color"));
    ...
    public void BodyColorChance()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba3>().MateyelEsitlemeBody();
        kalicirimdiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba3>().gecicirim.color;
    }
    ...
    public void WheelColorChance()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba3>().MateyelEsitlemeRim();
        kalicibodydiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba3>().gecicibody.color;
    ...
    public void BackButton()
    {
        ...
        chechFonkBody = false;
        checkFonk2 = true;
        kalicibodydiger.color = ColorPaletteControllerAraba3.Current.gecicibody.color;
        kalicirimdiger.color = ColorPaletteControllerAraba3.Current.gecicirim.color;
    }
    ...
    public void BodySellUpdateCoin()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba3>().UpdateColor();
