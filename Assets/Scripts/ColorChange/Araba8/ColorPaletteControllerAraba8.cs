...
public class ColorPaletteControllerAraba8 : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IInitializePotentialDragHandler
{
    public static ColorPaletteControllerAraba8 Current;
    ...
    {
        PlayerPrefs.SetString("SavedBodyAraba8Color", ColorToHexBody(color));
    }

    void SaveColorRim(Color color)
    {
        PlayerPrefs.SetString("SavedRimAraba8Color", ColorToHexRim(color));
    }
    ...
    public void UpdateColor()
    {
        ...
        if (pickedColorImage)
        {
            pickedColorImage.color = color;
            SelectedColor = color;
            if (VehicleColorAraba8.Current.chechFonkBody == true)
            {
                MateyelGuncellemeBody();
                SaveColorBody(kalicibody.color);
                VehicleColorAraba8.Current.chechFonkBody = false;
            }
            else if (VehicleColorAraba8.Current.checkFonkRim == true)
            {
                MateyelGuncellemeRim();
                SaveColorRim(kalicirim.color);
                VehicleColorAraba8.Current.checkFonkRim = false;
            }
            else if (VehicleColorAraba8.Current.chechFonkBody == false && VehicleColorAraba8.Current.checkFonk2 == true || VehicleColorAraba8.Current.checkFonkRim == false && VehicleColorAraba8.Current.checkFonk2 == true)
            {
                MateyelEsitlemeBody();
                MateyelEsitlemeRim();
            }
