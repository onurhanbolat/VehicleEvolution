...
public class VehicleColorAraba8 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (!PlayerPrefs.HasKey("kontrolAraba8"))
        {
            baslangicbodyrengi = PlayerPrefs.GetString("SavedBodyAraba8Color") + "8A8A8A";
            baslangicrimrengi = PlayerPrefs.GetString("SavedRimAraba8Color") + "313131";
            PlayerPrefs.SetString("SavedBodyAraba8Color", baslangicbodyrengi);
            PlayerPrefs.SetString("SavedRimAraba8Color", baslangicrimrengi);
            PlayerPrefs.SetInt("kontrolAraba8", 1);
        }
        else
        {
            PlayerPrefs.GetString("SavedBodyAraba8Color");
            PlayerPrefs.GetString("SavedRimAraba8Color");
        }
        kalicibodydiger.color = HexToColor(PlayerPrefs.GetString("SavedBodyAraba8Color"));
        kalicirimdiger.color = HexToColor(PlayerPrefs.GetString("SavedRimAraba8Color"));
    ...
    public void BodyColorChance()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba8>().MateyelEsitlemeBody();
        kalicirimdiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba8>().gecicirim.color;
    }
    ...
    public void WheelColorChance()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba8>().MateyelEsitlemeRim();
        kalicibodydiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba8>().gecicibody.color;
    ...
    public void BackButton()
    {
        ...
        chechFonkBody = false;
        checkFonk2 = true;
        kalicibodydiger.color = ColorPaletteControllerAraba8.Current.gecicibody.color;
        kalicirimdiger.color = ColorPaletteControllerAraba8.Current.gecicirim.color;
    }
    ...
    public void BodySellUpdateCoin()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba8>().UpdateColor();
