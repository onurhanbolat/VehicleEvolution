...
public class VehicleColorAraba5 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (!PlayerPrefs.HasKey("kontrolAraba5"))
        {
            baslangicbodyrengi = PlayerPrefs.GetString("SavedBodyAraba5Color") + "8A8A8A";
            baslangicrimrengi = PlayerPrefs.GetString("SavedRimAraba5Color") + "313131";
            PlayerPrefs.SetString("SavedBodyAraba5Color", baslangicbodyrengi);
            PlayerPrefs.SetString("SavedRimAraba5Color", baslangicrimrengi);
            PlayerPrefs.SetInt("kontrolAraba5", 1);
        }
        else
        {
            PlayerPrefs.GetString("SavedBodyAraba5Color");
            PlayerPrefs.GetString("SavedRimAraba5Color");
        }
        kalicibodydiger.color = HexToColor(PlayerPrefs.GetString("SavedBodyAraba5Color"));
        kalicirimdiger.color = HexToColor(PlayerPrefs.GetString("SavedRimAraba5Color"));
    ...
    public void BodyColorChance()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba5>().MateyelEsitlemeBody();
        kalicirimdiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba5>().gecicirim.color;
    }
    ...
    public void WheelColorChance()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba5>().MateyelEsitlemeRim();
        kalicibodydiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba5>().gecicibody.color;
    ...
    public void BackButton()
    {
        ...
        chechFonkBody = false;
        checkFonk2 = true;
        kalicibodydiger.color = ColorPaletteControllerAraba5.Current.gecicibody.color;
        kalicirimdiger.color = ColorPaletteControllerAraba5.Current.gecicirim.color;
    }
    ...
    public void BodySellUpdateCoin()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba5>().UpdateColor();
