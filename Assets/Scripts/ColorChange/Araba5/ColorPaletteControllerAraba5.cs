...
public class ColorPaletteControllerAraba5 : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IInitializePotentialDragHandler
{
    public static ColorPaletteControllerAraba5 Current;
    ...
    {
        PlayerPrefs.SetString("SavedBodyAraba5Color", ColorToHexBody(color));
    }

    void SaveColorRim(Color color)
    {
        PlayerPrefs.SetString("SavedRimAraba5Color", ColorToHexRim(color));
    }
    ...
    public void UpdateColor()
    {
        ...
        if (pickedColorImage)
        {
            pickedColorImage.color = color;
            SelectedColor = color;
            if (VehicleColorAraba5.Current.chechFonkBody == true)
            {
                MateyelGuncellemeBody();
                SaveColorBody(kalicibody.color);
                VehicleColorAraba5.Current.chechFonkBody = false;
            }
            else if (VehicleColorAraba5.Current.checkFonkRim == true)
            {
                MateyelGuncellemeRim();
                SaveColorRim(kalicirim.color);
                VehicleColorAraba5.Current.checkFonkRim = false;
            }
            else if (VehicleColorAraba5.Current.chechFonkBody == false && VehicleColorAraba5.Current.checkFonk2 == true || VehicleColorAraba5.Current.checkFonkRim == false && VehicleColorAraba5.Current.checkFonk2 == true)
            {
                MateyelEsitlemeBody();
                MateyelEsitlemeRim();
            }
