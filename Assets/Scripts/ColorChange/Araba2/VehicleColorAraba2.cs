...
public class VehicleColorAraba2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (!PlayerPrefs.HasKey("kontrolAraba2"))
        {
            baslangicbodyrengi = PlayerPrefs.GetString("SavedBodyAraba2Color") + "8A8A8A";
            baslangicrimrengi = PlayerPrefs.GetString("SavedRimAraba2Color") + "313131";
            PlayerPrefs.SetString("SavedBodyAraba2Color", baslangicbodyrengi);
            PlayerPrefs.SetString("SavedRimAraba2Color", baslangicrimrengi);
            PlayerPrefs.SetInt("kontrolAraba2", 1);
        }
        else
        {
            PlayerPrefs.GetString("SavedBodyAraba2Color");
            PlayerPrefs.GetString("SavedRimAraba2Color");
        }
        kalicibodydiger.color = HexToColor(PlayerPrefs.GetString("SavedBodyAraba2Color"));
        kalicirimdiger.color = HexToColor(PlayerPrefs.GetString("SavedRimAraba2Color"));
    ...
    public void BodyColorChance()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba2>().MateyelEsitlemeBody();
        kalicirimdiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba2>().gecicirim.color;
    }
    ...
    public void WheelColorChance()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba2>().MateyelEsitlemeRim();
        kalicibodydiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba2>().gecicibody.color;
    ...
    public void BackButton()
    {
        ...
        chechFonkBody = false;
        checkFonk2 = true;
        kalicibodydiger.color = ColorPaletteControllerAraba2.Current.gecicibody.color;
        kalicirimdiger.color = ColorPaletteControllerAraba2.Current.gecicirim.color;
    }
    ...
    public void BodySellUpdateCoin()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba2>().UpdateColor();
