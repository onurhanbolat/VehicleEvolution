...
public class VehicleColorMotor3 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (!PlayerPrefs.HasKey("kontrol9"))
        {
            baslangicbodyrengi = PlayerPrefs.GetString("SavedMotor3BodyColor") + "8A8A8A";
            baslangicrimrengi = PlayerPrefs.GetString("SavedMotor3RimColor") + "939393";
            PlayerPrefs.SetString("SavedMotor3BodyColor", baslangicbodyrengi);
            PlayerPrefs.SetString("SavedMotor3RimColor", baslangicrimrengi);
            PlayerPrefs.SetInt("kontrol9", 1);
        }
        else
        {
            PlayerPrefs.GetString("SavedMotor3BodyColor");
            PlayerPrefs.GetString("SavedMotor3RimColor");
        }
        kalicibodydiger.color = HexToColor(PlayerPrefs.GetString("SavedMotor3BodyColor"));
        kalicirimdiger.color = HexToColor(PlayerPrefs.GetString("SavedMotor3RimColor"));
    ...
    public void BodyColorChance()
    {
        ...
        GameObject.FindWithTag("MainCamera").GetComponent<CameraControl>().offset.z = 3.21f;
        camera.transform.rotation = Quaternion.Euler(new Vector3(1.11f, -129.09f, 0));
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerMotor3>().MateyelEsitlemeBody();
        kalicirimdiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerMotor3>().gecicirim.color;
    }
    ...
    public void WheelColorChance()
    {
        ...
        GameObject.FindWithTag("MainCamera").GetComponent<CameraControl>().offset.z = 1.65f;
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerMotor3>().MateyelEsitlemeRim();
        kalicibodydiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerMotor3>().gecicibody.color;
    ...
    public void BackButton()
    {
        ...
        chechFonkBody = false;
        checkFonk2 = true;
        kalicibodydiger.color = ColorPaletteControllerMotor3.Current.gecicibody.color;
        kalicirimdiger.color = ColorPaletteControllerMotor3.Current.gecicirim.color;
    }
    ...
    public void BodySellUpdateCoin()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerMotor3>().UpdateColor();
