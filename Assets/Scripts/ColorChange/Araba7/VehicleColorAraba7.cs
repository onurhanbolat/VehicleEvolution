...
public class VehicleColorAraba7 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (!PlayerPrefs.HasKey("kontrolAraba7"))
        {
            baslangicbodyrengi = PlayerPrefs.GetString("SavedBodyAraba7Color") + "8A8A8A";
            baslangicrimrengi = PlayerPrefs.GetString("SavedRimAraba7Color") + "313131";
            PlayerPrefs.SetString("SavedBodyAraba7Color", baslangicbodyrengi);
            PlayerPrefs.SetString("SavedRimAraba7Color", baslangicrimrengi);
            PlayerPrefs.SetInt("kontrolAraba7", 1);
        }
        else
        {
            PlayerPrefs.GetString("SavedBodyAraba7Color");
            PlayerPrefs.GetString("SavedRimAraba7Color");
        }
        kalicibodydiger.color = HexToColor(PlayerPrefs.GetString("SavedBodyAraba7Color"));
        kalicirimdiger.color = HexToColor(PlayerPrefs.GetString("SavedRimAraba7Color"));
    ...
    public void BodyColorChance()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba7>().MateyelEsitlemeBody();
        kalicirimdiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba7>().gecicirim.color;
    }
    ...
    public void WheelColorChance()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba7>().MateyelEsitlemeRim();
        kalicibodydiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba7>().gecicibody.color;
    ...
    public void BackButton()
    {
        ...
        chechFonkBody = false;
        checkFonk2 = true;
        kalicibodydiger.color = ColorPaletteControllerAraba7.Current.gecicibody.color;
        kalicirimdiger.color = ColorPaletteControllerAraba7.Current.gecicirim.color;
    }
    ...
    public void BodySellUpdateCoin()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba7>().UpdateColor();
