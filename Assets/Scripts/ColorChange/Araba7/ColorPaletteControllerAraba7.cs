...
public class ColorPaletteControllerAraba7 : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IInitializePotentialDragHandler
{
    public static ColorPaletteControllerAraba7 Current;
    ...
    {
        PlayerPrefs.SetString("SavedBodyAraba7Color", ColorToHexBody(color));
    }

    void SaveColorRim(Color color)
    {
        PlayerPrefs.SetString("SavedRimAraba7Color", ColorToHexRim(color));
    }
    ...
    public void UpdateColor()
    {
        ...
        if (pickedColorImage)
        {
            pickedColorImage.color = color;
            SelectedColor = color;
            if (VehicleColorAraba7.Current.chechFonkBody == true)
            {
                MateyelGuncellemeBody();
                SaveColorBody(kalicibody.color);
                VehicleColorAraba7.Current.chechFonkBody = false;
            }
            else if (VehicleColorAraba7.Current.checkFonkRim == true)
            {
                MateyelGuncellemeRim();
                SaveColorRim(kalicirim.color);
                VehicleColorAraba7.Current.checkFonkRim = false;
            }
            else if (VehicleColorAraba7.Current.chechFonkBody == false && VehicleColorAraba7.Current.checkFonk2 == true || VehicleColorAraba7.Current.checkFonkRim == false && VehicleColorAraba7.Current.checkFonk2 == true)
            {
                MateyelEsitlemeBody();
                MateyelEsitlemeRim();
            }
