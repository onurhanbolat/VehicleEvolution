...
public class VehicleColorAraba17 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (!PlayerPrefs.HasKey("kontrolAraba17"))
        {
            baslangicbodyrengi = PlayerPrefs.GetString("SavedBodyAraba17Color") + "8A8A8A";
            baslangicrimrengi = PlayerPrefs.GetString("SavedRimAraba17Color") + "313131";
            PlayerPrefs.SetString("SavedBodyAraba17Color", baslangicbodyrengi);
            PlayerPrefs.SetString("SavedRimAraba17Color", baslangicrimrengi);
            PlayerPrefs.SetInt("kontrolAraba17", 1);
        }
        else
        {
            PlayerPrefs.GetString("SavedBodyAraba17Color");
            PlayerPrefs.GetString("SavedRimAraba17Color");
        }
        kalicibodydiger.color = HexToColor(PlayerPrefs.GetString("SavedBodyAraba17Color"));
        kalicirimdiger.color = HexToColor(PlayerPrefs.GetString("SavedRimAraba17Color"));
    ...
    public void BodyColorChance()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba17>().MateyelEsitlemeBody();
        kalicirimdiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba17>().gecicirim.color;
    }
    ...
    public void WheelColorChance()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba17>().MateyelEsitlemeRim();
        kalicibodydiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba17>().gecicibody.color;
    ...
    public void BackButton()
    {
        ...
        chechFonkBody = false;
        checkFonk2 = true;
        kalicibodydiger.color = ColorPaletteControllerAraba17.Current.gecicibody.color;
        kalicirimdiger.color = ColorPaletteControllerAraba17.Current.gecicirim.color;
    }
    ...
    public void BodySellUpdateCoin()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba17>().UpdateColor();
