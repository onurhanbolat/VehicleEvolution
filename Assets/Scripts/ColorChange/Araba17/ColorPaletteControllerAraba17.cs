...
public class ColorPaletteControllerAraba17 : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IInitializePotentialDragHandler
{
    public static ColorPaletteControllerAraba17 Current;
    ...
    {
        PlayerPrefs.SetString("SavedBodyAraba17Color", ColorToHexBody(color));
    }

    void SaveColorRim(Color color)
    {
        PlayerPrefs.SetString("SavedRimAraba17Color", ColorToHexRim(color));
    }
    ...
    public void UpdateColor()
    {
        ...
        if (pickedColorImage)
        {
            pickedColorImage.color = color;
            SelectedColor = color;
            if (VehicleColorAraba17.Current.chechFonkBody == true)
            {
                MateyelGuncellemeBody();
                SaveColorBody(kalicibody.color);
                VehicleColorAraba17.Current.chechFonkBody = false;
            }
            else if (VehicleColorAraba17.Current.checkFonkRim == true)
            {
                MateyelGuncellemeRim();
                SaveColorRim(kalicirim.color);
                VehicleColorAraba17.Current.checkFonkRim = false;
            }
            else if (VehicleColorAraba17.Current.chechFonkBody == false && VehicleColorAraba17.Current.checkFonk2 == true || VehicleColorAraba17.Current.checkFonkRim == false && VehicleColorAraba17.Current.checkFonk2 == true)
            {
                MateyelEsitlemeBody();
                MateyelEsitlemeRim();
            }
