...
public class VehicleColorAraba10 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (!PlayerPrefs.HasKey("kontrolAraba10"))
        {
            baslangicbodyrengi = PlayerPrefs.GetString("SavedBodyAraba10Color") + "8A8A8A";
            baslangicrimrengi = PlayerPrefs.GetString("SavedRimAraba10Color") + "313131";
            PlayerPrefs.SetString("SavedBodyAraba10Color", baslangicbodyrengi);
            PlayerPrefs.SetString("SavedRimAraba10Color", baslangicrimrengi);
            PlayerPrefs.SetInt("kontrolAraba10", 1);
        }
        else
        {
            PlayerPrefs.GetString("SavedBodyAraba10Color");
            PlayerPrefs.GetString("SavedRimAraba10Color");
        }
        kalicibodydiger.color = HexToColor(PlayerPrefs.GetString("SavedBodyAraba10Color"));
        kalicirimdiger.color = HexToColor(PlayerPrefs.GetString("SavedRimAraba10Color"));
    ...
    public void BodyColorChance()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba10>().MateyelEsitlemeBody();
        kalicirimdiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba10>().gecicirim.color;
    }
    ...
    public void WheelColorChance()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba10>().MateyelEsitlemeRim();
        kalicibodydiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba10>().gecicibody.color;
    ...
    public void BackButton()
    {
        ...
        chechFonkBody = false;
        checkFonk2 = true;
        kalicibodydiger.color = ColorPaletteControllerAraba10.Current.gecicibody.color;
        kalicirimdiger.color = ColorPaletteControllerAraba10.Current.gecicirim.color;
    }
    ...
    public void BodySellUpdateCoin()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba10>().UpdateColor();
