...
public class ColorPaletteControllerAraba10 : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IInitializePotentialDragHandler
{
    public static ColorPaletteControllerAraba10 Current;
    ...
    {
        PlayerPrefs.SetString("SavedBodyAraba10Color", ColorToHexBody(color));
    }

    void SaveColorRim(Color color)
    {
        PlayerPrefs.SetString("SavedRimAraba10Color", ColorToHexRim(color));
    }
    ...
    public void UpdateColor()
    {
        ...
        if (pickedColorImage)
        {
            pickedColorImage.color = color;
            SelectedColor = color;
            if (VehicleColorAraba10.Current.chechFonkBody == true)
            {
                MateyelGuncellemeBody();
                SaveColorBody(kalicibody.color);
                VehicleColorAraba10.Current.chechFonkBody = false;
            }
            else if (VehicleColorAraba10.Current.checkFonkRim == true)
            {
                MateyelGuncellemeRim();
                SaveColorRim(kalicirim.color);
                VehicleColorAraba10.Current.checkFonkRim = false;
            }
            else if (VehicleColorAraba10.Current.chechFonkBody == false && VehicleColorAraba10.Current.checkFonk2 == true || VehicleColorAraba10.Current.checkFonkRim == false && VehicleColorAraba10.Current.checkFonk2 == true)
            {
                MateyelEsitlemeBody();
                MateyelEsitlemeRim();
            }
