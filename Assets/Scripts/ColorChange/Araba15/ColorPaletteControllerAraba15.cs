...
public class ColorPaletteControllerAraba15 : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IInitializePotentialDragHandler
{
    public static ColorPaletteControllerAraba15 Current;
    ...
    {
        PlayerPrefs.SetString("SavedBodyAraba15Color", ColorToHexBody(color));
    }

    void SaveColorRim(Color color)
    {
        PlayerPrefs.SetString("SavedRimAraba15Color", ColorToHexRim(color));
    }
    ...
    public void UpdateColor()
    {
        ...
        if (pickedColorImage)
        {
            pickedColorImage.color = color;
            SelectedColor = color;
            if (VehicleColorAraba15.Current.chechFonkBody == true)
            {
                MateyelGuncellemeBody();
                SaveColorBody(kalicibody.color);
                VehicleColorAraba15.Current.chechFonkBody = false;
            }
            else if (VehicleColorAraba15.Current.checkFonkRim == true)
            {
                MateyelGuncellemeRim();
                SaveColorRim(kalicirim.color);
                VehicleColorAraba15.Current.checkFonkRim = false;
            }
            else if (VehicleColorAraba15.Current.chechFonkBody == false && VehicleColorAraba15.Current.checkFonk2 == true || VehicleColorAraba15.Current.checkFonkRim == false && VehicleColorAraba15.Current.checkFonk2 == true)
            {
                MateyelEsitlemeBody();
                MateyelEsitlemeRim();
            }
