...
public class VehicleColorAraba15 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (!PlayerPrefs.HasKey("kontrolAraba15"))
        {
            baslangicbodyrengi = PlayerPrefs.GetString("SavedBodyAraba15Color") + "8A8A8A";
            baslangicrimrengi = PlayerPrefs.GetString("SavedRimAraba15Color") + "313131";
            PlayerPrefs.SetString("SavedBodyAraba15Color", baslangicbodyrengi);
            PlayerPrefs.SetString("SavedRimAraba15Color", baslangicrimrengi);
            PlayerPrefs.SetInt("kontrolAraba15", 1);
        }
        else
        {
            PlayerPrefs.GetString("SavedBodyAraba15Color");
            PlayerPrefs.GetString("SavedRimAraba15Color");
        }
        kalicibodydiger.color = HexToColor(PlayerPrefs.GetString("SavedBodyAraba15Color"));
        kalicirimdiger.color = HexToColor(PlayerPrefs.GetString("SavedRimAraba15Color"));
    ...
    public void BodyColorChance()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba15>().MateyelEsitlemeBody();
        kalicirimdiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba15>().gecicirim.color;
    }
    ...
    public void WheelColorChance()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba15>().MateyelEsitlemeRim();
        kalicibodydiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba15>().gecicibody.color;
    ...
    public void BackButton()
    {
        ...
        chechFonkBody = false;
        checkFonk2 = true;
        kalicibodydiger.color = ColorPaletteControllerAraba15.Current.gecicibody.color;
        kalicirimdiger.color = ColorPaletteControllerAraba15.Current.gecicirim.color;
    }
    ...
    public void BodySellUpdateCoin()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba15>().UpdateColor();
