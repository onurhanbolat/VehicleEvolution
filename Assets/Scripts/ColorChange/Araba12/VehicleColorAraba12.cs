...
public class VehicleColorAraba12 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (!PlayerPrefs.HasKey("kontrolAraba12"))
        {
            baslangicbodyrengi = PlayerPrefs.GetString("SavedBodyAraba12Color") + "8A8A8A";
            baslangicrimrengi = PlayerPrefs.GetString("SavedRimAraba12Color") + "313131";
            PlayerPrefs.SetString("SavedBodyAraba12Color", baslangicbodyrengi);
            PlayerPrefs.SetString("SavedRimAraba12Color", baslangicrimrengi);
            PlayerPrefs.SetInt("kontrolAraba12", 1);
        }
        else
        {
            PlayerPrefs.GetString("SavedBodyAraba12Color");
            PlayerPrefs.GetString("SavedRimAraba12Color");
        }
        kalicibodydiger.color = HexToColor(PlayerPrefs.GetString("SavedBodyAraba12Color"));
        kalicirimdiger.color = HexToColor(PlayerPrefs.GetString("SavedRimAraba12Color"));
    ...
    public void BodyColorChance()
    {
        ...
        GameObject.FindWithTag("MainCamera").GetComponent<CameraControl>().offset.x = 1.86f;
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba12>().MateyelEsitlemeBody();
        kalicirimdiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba12>().gecicirim.color;
    }
    ...
    public void WheelColorChance()
    {
        ...
        GameObject.FindWithTag("MainCamera").GetComponent<CameraControl>().offset.z = 0.82f;
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba12>().MateyelEsitlemeRim();
        kalicibodydiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba12>().gecicibody.color;
    ...
    public void BackButton()
    {
        ...
        chechFonkBody = false;
        checkFonk2 = true;
        kalicibodydiger.color = ColorPaletteControllerAraba12.Current.gecicibody.color;
        kalicirimdiger.color = ColorPaletteControllerAraba12.Current.gecicirim.color;
    }
    ...
    public void BodySellUpdateCoin()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba12>().UpdateColor();
