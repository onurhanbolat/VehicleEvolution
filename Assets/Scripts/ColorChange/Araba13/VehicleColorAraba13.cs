...
public class VehicleColorAraba13 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (!PlayerPrefs.HasKey("kontrolAraba13"))
        {
            baslangicbodyrengi = PlayerPrefs.GetString("SavedBodyAraba13Color") + "8A8A8A";
            baslangicrimrengi = PlayerPrefs.GetString("SavedRimAraba13Color") + "313131";
            PlayerPrefs.SetString("SavedBodyAraba13Color", baslangicbodyrengi);
            PlayerPrefs.SetString("SavedRimAraba13Color", baslangicrimrengi);
            PlayerPrefs.SetInt("kontrolAraba13", 1);
        }
        else
        {
            PlayerPrefs.GetString("SavedBodyAraba13Color");
            PlayerPrefs.GetString("SavedRimAraba13Color");
        }
        kalicibodydiger.color = HexToColor(PlayerPrefs.GetString("SavedBodyAraba13Color"));
        kalicirimdiger.color = HexToColor(PlayerPrefs.GetString("SavedRimAraba13Color"));
    ...
    public void BodyColorChance()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba13>().MateyelEsitlemeBody();
        kalicirimdiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba13>().gecicirim.color;
    }
    ...
    public void WheelColorChance()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba13>().MateyelEsitlemeRim();
        kalicibodydiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba13>().gecicibody.color;
    ...
    public void BackButton()
    {
        ...
        chechFonkBody = false;
        checkFonk2 = true;
        kalicibodydiger.color = ColorPaletteControllerAraba13.Current.gecicibody.color;
        kalicirimdiger.color = ColorPaletteControllerAraba13.Current.gecicirim.color;
    }
    ...
    public void BodySellUpdateCoin()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba13>().UpdateColor();
