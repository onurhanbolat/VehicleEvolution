...
public class ColorPaletteControllerAraba13 : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IInitializePotentialDragHandler
{
    public static ColorPaletteControllerAraba13 Current;
    ...
    {
        PlayerPrefs.SetString("SavedBodyAraba13Color", ColorToHexBody(color));
    }

    void SaveColorRim(Color color)
    {
        PlayerPrefs.SetString("SavedRimAraba13Color", ColorToHexRim(color));
    }
    ...
    public void UpdateColor()
    {
        ...
        if (pickedColorImage)
        {
            pickedColorImage.color = color;
            SelectedColor = color;
            if (VehicleColorAraba13.Current.chechFonkBody == true)
            {
                MateyelGuncellemeBody();
                SaveColorBody(kalicibody.color);
                VehicleColorAraba13.Current.chechFonkBody = false;
            }
            else if (VehicleColorAraba13.Current.checkFonkRim == true)
            {
                MateyelGuncellemeRim();
                SaveColorRim(kalicirim.color);
                VehicleColorAraba13.Current.checkFonkRim = false;
            }
            else if (VehicleColorAraba13.Current.chechFonkBody == false && VehicleColorAraba13.Current.checkFonk2 == true || VehicleColorAraba13.Current.checkFonkRim == false && VehicleColorAraba13.Current.checkFonk2 == true)
            {
                MateyelEsitlemeBody();
                MateyelEsitlemeRim();
            }
