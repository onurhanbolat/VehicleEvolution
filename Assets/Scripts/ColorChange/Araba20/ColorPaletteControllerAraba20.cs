...
public class ColorPaletteControllerAraba20 : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IInitializePotentialDragHandler
{
    public static ColorPaletteControllerAraba20 Current;
    ...
    {
        PlayerPrefs.SetString("SavedBodyAraba20Color", ColorToHexBody(color));
    }

    void SaveColorRim(Color color)
    {
        PlayerPrefs.SetString("SavedRimAraba20Color", ColorToHexRim(color));
    }
    ...
    public void UpdateColor()
    {
        ...
        if (pickedColorImage)
        {
            pickedColorImage.color = color;
            SelectedColor = color;
            if (VehicleColorAraba20.Current.chechFonkBody == true)
            {
                MateyelGuncellemeBody();
                SaveColorBody(kalicibody.color);
                VehicleColorAraba20.Current.chechFonkBody = false;
            }
            else if (VehicleColorAraba20.Current.checkFonkRim == true)
            {
                MateyelGuncellemeRim();
                SaveColorRim(kalicirim.color);
                VehicleColorAraba20.Current.checkFonkRim = false;
            }
            else if (VehicleColorAraba20.Current.chechFonkBody == false && VehicleColorAraba20.Current.checkFonk2 == true || VehicleColorAraba20.Current.checkFonkRim == false && VehicleColorAraba20.Current.checkFonk2 == true)
            {
                MateyelEsitlemeBody();
                MateyelEsitlemeRim();
            }
