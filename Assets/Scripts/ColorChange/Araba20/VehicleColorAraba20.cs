...
public class VehicleColorAraba20 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (!PlayerPrefs.HasKey("kontrolAraba20"))
        {
            baslangicbodyrengi = PlayerPrefs.GetString("SavedBodyAraba20Color") + "8A8A8A";
            baslangicrimrengi = PlayerPrefs.GetString("SavedRimAraba20Color") + "313131";
            PlayerPrefs.SetString("SavedBodyAraba20Color", baslangicbodyrengi);
            PlayerPrefs.SetString("SavedRimAraba20Color", baslangicrimrengi);
            PlayerPrefs.SetInt("kontrolAraba20", 1);
        }
        else
        {
            PlayerPrefs.GetString("SavedBodyAraba20Color");
            PlayerPrefs.GetString("SavedRimAraba20Color");
        }
        kalicibodydiger.color = HexToColor(PlayerPrefs.GetString("SavedBodyAraba20Color"));
        kalicirimdiger.color = HexToColor(PlayerPrefs.GetString("SavedRimAraba20Color"));
    ...
    public void BodyColorChance()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba20>().MateyelEsitlemeBody();
        kalicirimdiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba20>().gecicirim.color;
    }
    ...
    public void WheelColorChance()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba20>().MateyelEsitlemeRim();
        kalicibodydiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba20>().gecicibody.color;
    ...
    public void BackButton()
    {
        ...
        chechFonkBody = false;
        checkFonk2 = true;
        kalicibodydiger.color = ColorPaletteControllerAraba20.Current.gecicibody.color;
        kalicirimdiger.color = ColorPaletteControllerAraba20.Current.gecicirim.color;
    }
    ...
    public void BodySellUpdateCoin()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba20>().UpdateColor();
