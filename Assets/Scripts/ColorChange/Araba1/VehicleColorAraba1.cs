...
public class VehicleColorAraba1 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (!PlayerPrefs.HasKey("kontrolAraba1"))
        {
            baslangicbodyrengi = PlayerPrefs.GetString("SavedBodyAraba1Color") + "8A8A8A";
            baslangicrimrengi = PlayerPrefs.GetString("SavedRimAraba1Color") + "313131";
            PlayerPrefs.SetString("SavedBodyAraba1Color", baslangicbodyrengi);
            PlayerPrefs.SetString("SavedRimAraba1Color", baslangicrimrengi);
            PlayerPrefs.SetInt("kontrolAraba1", 1);
        }
        else
        {
            PlayerPrefs.GetString("SavedBodyAraba1Color");
            PlayerPrefs.GetString("SavedRimAraba1Color");
        }
        kalicibodydiger.color = HexToColor(PlayerPrefs.GetString("SavedBodyAraba1Color"));
        kalicirimdiger.color = HexToColor(PlayerPrefs.GetString("SavedRimAraba1Color"));
    ...
    public void BodyColorChance()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba1>().MateyelEsitlemeBody();
        kalicirimdiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba1>().gecicirim.color;
    }
    ...
    public void WheelColorChance()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba1>().MateyelEsitlemeRim();
        kalicibodydiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba1>().gecicibody.color;
    ...
    public void BackButton()
    {
        ...
        chechFonkBody = false;
        checkFonk2 = true;
        kalicibodydiger.color = ColorPaletteControllerAraba1.Current.gecicibody.color;
        kalicirimdiger.color = ColorPaletteControllerAraba1.Current.gecicirim.color;
    }
    ...
    public void BodySellUpdateCoin()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba1>().UpdateColor();
