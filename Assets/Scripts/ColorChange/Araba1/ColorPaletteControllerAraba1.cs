...
public class ColorPaletteControllerAraba1 : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IInitializePotentialDragHandler
{
    public static ColorPaletteControllerAraba1 Current;
    ...
    {
        PlayerPrefs.SetString("SavedBodyAraba1Color", ColorToHexBody(color));
    }

    void SaveColorRim(Color color)
    {
        PlayerPrefs.SetString("SavedRimAraba1Color", ColorToHexRim(color));
    }
    ...
    public void UpdateColor()
    {
        ...
        if (pickedColorImage)
        {
            pickedColorImage.color = color;
            SelectedColor = color;
            if (VehicleColorAraba1.Current.chechFonkBody == true)
            {
                MateyelGuncellemeBody();
                SaveColorBody(kalicibody.color);
                VehicleColorAraba1.Current.chechFonkBody = false;
            }
            else if (VehicleColorAraba1.Current.checkFonkRim == true)
            {
                MateyelGuncellemeRim();
                SaveColorRim(kalicirim.color);
                VehicleColorAraba1.Current.checkFonkRim = false;
            }
            else if (VehicleColorAraba1.Current.chechFonkBody == false && VehicleColorAraba1.Current.checkFonk2 == true || VehicleColorAraba1.Current.checkFonkRim == false && VehicleColorAraba1.Current.checkFonk2 == true)
            {
                MateyelEsitlemeBody();
                MateyelEsitlemeRim();
            }
