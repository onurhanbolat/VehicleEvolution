...
public class ColorPaletteControllerMotor4 : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IInitializePotentialDragHandler
{
    public static ColorPaletteControllerMotor4 Current;
    ...
    {
        PlayerPrefs.SetString("SavedMotor4BodyColor", ColorToHexBody(color));
    }

    void SaveColorRim(Color color)
    {
        PlayerPrefs.SetString("SavedMotor4RimColor", ColorToHexRim(color));
    }
    ...
    public void UpdateColor()
    {
        ...
        if (pickedColorImage)
        {
            pickedColorImage.color = color;
            SelectedColor = color;
            if (VehicleColorMotor4.Current.chechFonkBody == true)
            {
                MateyelGuncellemeBody();
                SaveColorBody(kalicibody.color);
                VehicleColorMotor4.Current.chechFonkBody = false;
            }
            else if (VehicleColorMotor4.Current.checkFonkRim == true)
            {
                MateyelGuncellemeRim();
                SaveColorRim(kalicirim.color);
                VehicleColorMotor4.Current.checkFonkRim = false;
            }
            else if (VehicleColorMotor4.Current.chechFonkBody == false && VehicleColorMotor4.Current.checkFonk2 == true || VehicleColorMotor4.Current.checkFonkRim == false && VehicleColorMotor4.Current.checkFonk2 == true)
            {
                MateyelEsitlemeBody();
                MateyelEsitlemeRim();
            }
