...
public class ColorPaletteControllerAraba18 : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IInitializePotentialDragHandler
{
    public static ColorPaletteControllerAraba18 Current;
    ...
    {
        PlayerPrefs.SetString("SavedBodyAraba18Color", ColorToHexBody(color));
    }

    void SaveColorRim(Color color)
    {
        PlayerPrefs.SetString("SavedRimAraba18Color", ColorToHexRim(color));
    }
    ...
    public void UpdateColor()
    {
        ...
        if (pickedColorImage)
        {
            pickedColorImage.color = color;
            SelectedColor = color;
            if (VehicleColorAraba18.Current.chechFonkBody == true)
            {
                MateyelGuncellemeBody();
                SaveColorBody(kalicibody.color);
                VehicleColorAraba18.Current.chechFonkBody = false;
            }
            else if (VehicleColorAraba18.Current.checkFonkRim == true)
            {
                MateyelGuncellemeRim();
                SaveColorRim(kalicirim.color);
                VehicleColorAraba18.Current.checkFonkRim = false;
            }
            else if (VehicleColorAraba18.Current.chechFonkBody == false && VehicleColorAraba18.Current.checkFonk2 == true || VehicleColorAraba18.Current.checkFonkRim == false && VehicleColorAraba18.Current.checkFonk2 == true)
            {
                MateyelEsitlemeBody();
                MateyelEsitlemeRim();
            }
