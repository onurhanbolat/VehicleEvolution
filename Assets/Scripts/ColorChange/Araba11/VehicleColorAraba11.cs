...
public class VehicleColorAraba11 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (!PlayerPrefs.HasKey("kontrolAraba11"))
        {
            baslangicbodyrengi = PlayerPrefs.GetString("SavedBodyAraba11Color") + "8A8A8A";
            baslangicrimrengi = PlayerPrefs.GetString("SavedRimAraba11Color") + "313131";
            PlayerPrefs.SetString("SavedBodyAraba11Color", baslangicbodyrengi);
            PlayerPrefs.SetString("SavedRimAraba11Color", baslangicrimrengi);
            PlayerPrefs.SetInt("kontrolAraba11", 1);
        }
        else
        {
            PlayerPrefs.GetString("SavedBodyAraba11Color");
            PlayerPrefs.GetString("SavedRimAraba11Color");
        }
        kalicibodydiger.color = HexToColor(PlayerPrefs.GetString("SavedBodyAraba11Color"));
        kalicirimdiger.color = HexToColor(PlayerPrefs.GetString("SavedRimAraba11Color"));
    ...
    public void BodyColorChance()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba11>().MateyelEsitlemeBody();
        kalicirimdiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba11>().gecicirim.color;
    }
    ...
    public void WheelColorChance()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba11>().MateyelEsitlemeRim();
        kalicibodydiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba11>().gecicibody.color;
    ...
    public void BackButton()
    {
        ...
        chechFonkBody = false;
        checkFonk2 = true;
        kalicibodydiger.color = ColorPaletteControllerAraba11.Current.gecicibody.color;
        kalicirimdiger.color = ColorPaletteControllerAraba11.Current.gecicirim.color;
    }
    ...
    public void BodySellUpdateCoin()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba11>().UpdateColor();
