...
public class ColorPaletteControllerAraba11 : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IInitializePotentialDragHandler
{
    public static ColorPaletteControllerAraba11 Current;
    ...
    {
        PlayerPrefs.SetString("SavedBodyAraba11Color", ColorToHexBody(color));
    }

    void SaveColorRim(Color color)
    {
        PlayerPrefs.SetString("SavedRimAraba11Color", ColorToHexRim(color));
    }
    ...
    public void UpdateColor()
    {
        ...
        if (pickedColorImage)
        {
            pickedColorImage.color = color;
            SelectedColor = color;
            if (VehicleColorAraba11.Current.chechFonkBody == true)
            {
                MateyelGuncellemeBody();
                SaveColorBody(kalicibody.color);
                VehicleColorAraba11.Current.chechFonkBody = false;
            }
            else if (VehicleColorAraba11.Current.checkFonkRim == true)
            {
                MateyelGuncellemeRim();
                SaveColorRim(kalicirim.color);
                VehicleColorAraba11.Current.checkFonkRim = false;
            }
            else if (VehicleColorAraba11.Current.chechFonkBody == false && VehicleColorAraba11.Current.checkFonk2 == true || VehicleColorAraba11.Current.checkFonkRim == false && VehicleColorAraba11.Current.checkFonk2 == true)
            {
                MateyelEsitlemeBody();
                MateyelEsitlemeRim();
            }
