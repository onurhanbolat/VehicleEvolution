...
public class ColorPaletteControllerAraba16 : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IInitializePotentialDragHandler
{
    public static ColorPaletteControllerAraba16 Current;
    ...
    {
        PlayerPrefs.SetString("SavedBodyAraba16Color", ColorToHexBody(color));
    }

    void SaveColorRim(Color color)
    {
        PlayerPrefs.SetString("SavedRimAraba16Color", ColorToHexRim(color));
    }
    ...
    public void UpdateColor()
    {
        ...
        if (pickedColorImage)
        {
            pickedColorImage.color = color;
            SelectedColor = color;
            if (VehicleColorAraba16.Current.chechFonkBody == true)
            {
                MateyelGuncellemeBody();
                SaveColorBody(kalicibody.color);
                VehicleColorAraba16.Current.chechFonkBody = false;
            }
            else if (VehicleColorAraba16.Current.checkFonkRim == true)
            {
                MateyelGuncellemeRim();
                SaveColorRim(kalicirim.color);
                VehicleColorAraba16.Current.checkFonkRim = false;
            }
            else if (VehicleColorAraba16.Current.chechFonkBody == false && VehicleColorAraba16.Current.checkFonk2 == true || VehicleColorAraba16.Current.checkFonkRim == false && VehicleColorAraba16.Current.checkFonk2 == true)
            {
                MateyelEsitlemeBody();
                MateyelEsitlemeRim();
            }
