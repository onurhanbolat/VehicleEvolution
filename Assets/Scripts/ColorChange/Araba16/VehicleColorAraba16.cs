...
public class VehicleColorAraba16 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (!PlayerPrefs.HasKey("kontrolAraba16"))
        {
            baslangicbodyrengi = PlayerPrefs.GetString("SavedBodyAraba16Color") + "8A8A8A";
            baslangicrimrengi = PlayerPrefs.GetString("SavedRimAraba16Color") + "313131";
            PlayerPrefs.SetString("SavedBodyAraba16Color", baslangicbodyrengi);
            PlayerPrefs.SetString("SavedRimAraba16Color", baslangicrimrengi);
            PlayerPrefs.SetInt("kontrolAraba16", 1);
        }
        else
        {
            PlayerPrefs.GetString("SavedBodyAraba16Color");
            PlayerPrefs.GetString("SavedRimAraba16Color");
        }
        kalicibodydiger.color = HexToColor(PlayerPrefs.GetString("SavedBodyAraba16Color"));
        kalicirimdiger.color = HexToColor(PlayerPrefs.GetString("SavedRimAraba16Color"));
    ...
    public void BodyColorChance()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba16>().MateyelEsitlemeBody();
        kalicirimdiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba16>().gecicirim.color;
    }
    ...
    public void WheelColorChance()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba16>().MateyelEsitlemeRim();
        kalicibodydiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba16>().gecicibody.color;
    ...
    public void BackButton()
    {
        ...
        chechFonkBody = false;
        checkFonk2 = true;
        kalicibodydiger.color = ColorPaletteControllerAraba16.Current.gecicibody.color;
        kalicirimdiger.color = ColorPaletteControllerAraba16.Current.gecicirim.color;
    }
    ...
    public void BodySellUpdateCoin()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba16>().UpdateColor();
