...
public class ColorPaletteControllerAraba4 : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IInitializePotentialDragHandler
{
    public static ColorPaletteControllerAraba4 Current;
    ...
    {
        PlayerPrefs.SetString("SavedBodyAraba4Color", ColorToHexBody(color));
    }

    void SaveColorRim(Color color)
    {
        PlayerPrefs.SetString("SavedRimAraba4Color", ColorToHexRim(color));
    }
    ...
    public void UpdateColor()
    {
        ...
        if (pickedColorImage)
        {
            pickedColorImage.color = color;
            SelectedColor = color;
            if (VehicleColorAraba4.Current.chechFonkBody == true)
            {
                MateyelGuncellemeBody();
                SaveColorBody(kalicibody.color);
                VehicleColorAraba4.Current.chechFonkBody = false;
            }
            else if (VehicleColorAraba4.Current.checkFonkRim == true)
            {
                MateyelGuncellemeRim();
                SaveColorRim(kalicirim.color);
                VehicleColorAraba4.Current.checkFonkRim = false;
            }
            else if (VehicleColorAraba4.Current.chechFonkBody == false && VehicleColorAraba4.Current.checkFonk2 == true || VehicleColorAraba4.Current.checkFonkRim == false && VehicleColorAraba4.Current.checkFonk2 == true)
            {
                MateyelEsitlemeBody();
                MateyelEsitlemeRim();
            }
