...
public class VehicleColorAraba4 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (!PlayerPrefs.HasKey("kontrolAraba4"))
        {
            baslangicbodyrengi = PlayerPrefs.GetString("SavedBodyAraba4Color") + "8A8A8A";
            baslangicrimrengi = PlayerPrefs.GetString("SavedRimAraba4Color") + "313131";
            PlayerPrefs.SetString("SavedBodyAraba4Color", baslangicbodyrengi);
            PlayerPrefs.SetString("SavedRimAraba4Color", baslangicrimrengi);
            PlayerPrefs.SetInt("kontrolAraba4", 1);
        }
        else
        {
            PlayerPrefs.GetString("SavedBodyAraba4Color");
            PlayerPrefs.GetString("SavedRimAraba4Color");
        }
        kalicibodydiger.color = HexToColor(PlayerPrefs.GetString("SavedBodyAraba4Color"));
        kalicirimdiger.color = HexToColor(PlayerPrefs.GetString("SavedRimAraba4Color"));
    ...
    public void BodyColorChance()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba4>().MateyelEsitlemeBody();
        kalicirimdiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba4>().gecicirim.color;
    }
    ...
    public void WheelColorChance()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba4>().MateyelEsitlemeRim();
        kalicibodydiger.color = GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba4>().gecicibody.color;
    ...
    public void BackButton()
    {
        ...
        chechFonkBody = false;
        checkFonk2 = true;
        kalicibodydiger.color = ColorPaletteControllerAraba4.Current.gecicibody.color;
        kalicirimdiger.color = ColorPaletteControllerAraba4.Current.gecicirim.color;
    }
    ...
    public void BodySellUpdateCoin()
    {
        ...
        GameObject.FindWithTag("palet").GetComponent<ColorPaletteControllerAraba4>().UpdateColor();
